...
\begin{enumerate}
	...
	\item\marginpar{\em Academic Representative}We further wish that the School of Computer Science do allow the {\em Carleton Computer Science Society} to act as our voice in terms of academic representation from time to time, and afford the {\em Carleton Computer Science Society} any and all privileges in relation to academic representation as they are needed;
	...
	\item\marginpar{\em Membership of the Society}The {\em Membership of the Society} shall be all Undergraduate Students enrolled at Carleton University in a Bachelor of Computer Science or any combined honours Bachelor degree recognized the School of Computer Science.
