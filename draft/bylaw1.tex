% vim: textwidth=0 noexpandtab shiftwidth=8 softtabstop=8
\documentclass{report}

% Comments are not intended to make it into the final document!
\usepackage{color}
\newcommand\comment{\par\color{red}\small\sf}
...
\begin{enumerate}
	...
	\item[]{\comment I'm not sure that margin notes belong in the preamble.}
	...
	\item\marginpar{\em Short Title}The Bylaws of the {\em Carleton Computer Science Society} may be henceforth cited as the {\em Consitution of the Carleton Computer Science Society}.
        {\comment Wait, all bylaws comprise the Constitution? (This is relevant later, for enacting/amending new bylaws, and for amending this Constitution.)}
	...
	\item\marginpar{\em Objects of the Society}The {\em Objects of the Society} shall be
		\begin{enumerate}
			...
			\item to maintain status as a departmental society of Carleton University, as per the {\em Accreditation of Student Organizations Policy}.
                        {\comment This is a good thing, but the Policy on the Secretariat's site (which may be out of date) says ``Memberships in accredited Student Organizations other than CUSA, GSA and RRRA shall be open to all members of the University community,'' which may contradict the Membership of the Society provisions. Also of note: except for CUSA, GSA, and RRRA, ``incorporated societies'' can't be accredited Student Organizations.}
		\end{enumerate}
	...
	{\comment What about minors, double majors, etc.?}
	...
	{\comment Was honourary membership meant to expire ever?}
	...
	\item\marginpar{\em Initial Meeting of the Board of Directors}The {\em Intital Meeting} of the {\em Board of Directors} shall be held within the first two weeks of May of a {\em Society Year}, and shall be to
		\begin{enumerate}
			...
			{\comment So there can be at most 5 ($=\lfloor9/2\rfloor$) directors with portfolios?}
	...
	\item\marginpar{\em Subsequent Bylaws}The {\em Board of Directors} may enact, amend, or repeal Bylaws further to this Bylaw, provided such documents 
		\begin{enumerate}
			...
			{\comment So no bylaw may add anything really new\ldots how does this interact with the Amending Procedure at the end?}
		\end{enumerate}
	...
	\item\marginpar{\em Selection of the President}The {\em President} shall be selected, except in the case of a vacancy, by a plurality vote by and from the {\em Membership of the Society}, provided that the 
		\begin{enumerate}
			...
			{\comment Do you really want to require that the balloting be electronic in the Constitution? That seems more like bylaw or standing-resolution material if it isn't left to the discretion of the Returning Officer/Electoral Officer (a post that hasn't been mentioned at all in here, but I assume must exist).}
		\end{enumerate}
	...
	{\comment How does the President resign? (The president \emph{is} the chair of the Board.)}
	...
	{\comment What, all three at once? Or any one of the three? I'd expect (e.g.) a cheque to require the signatures of two of those three.}
	...
	{\comment What is a ``clear majority''? $50\%+1$? $60\%$? Is there a quorum?}

	\section*{\sc Extenuating Circumstances}
	{\comment I understand the reason for this section, but can't there be some mechanism to remove it automatically once it's no longer required?  Like making it Bylaw 2 with an automatic self-repealing clause? \par It's also not clear whether this is setting up a new organization in the place of an old one, or just the same CCSS adopting a brand new Constitution.}
	...
	\item\marginpar{\em 2011/2012 Society Year}For the purposes of the 2011/2012 {\em Society Year}, notwithstanding any provision of this Bylaw or any Bylaws enacted subsequent or any Bylaw or other Constitutional document enacted previously,
		\begin{enumerate}
			...
			{\comment This really doesn't need to be here in any case. Once you have a Board, just hold a quick meeting to dole out the portfolios.  It'll take 5 minutes and save 10 lines in the Constitution.}
		\end{enumerate}
